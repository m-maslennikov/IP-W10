  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        <!-- Blog Post -->
        <div class="card mb-4">
          <img class="card-img-top" src="images/cars/compact.jpg" alt="Card image cap">
          <div class="card-body">
            <h2 class="card-title">Honda Fit</h2>
            <p class="card-text">Color: Red</p>
            <p class="card-text">Status: Available</p>
            <p class="card-text">Body Type: Hatchback</p>
            <p class="card-text">Number of Seats: 5</p>
            <p class="card-text">Number of Doors: 5</p>
            <p class="card-text">Power: 120hp</p>
