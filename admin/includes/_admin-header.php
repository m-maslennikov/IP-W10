...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Accounts -->
      <li class="nav-item <?php if($current == 'accounts') {echo ' active';} ?>">
      ...
      <!-- Nav Item - Categories -->
      <li class="nav-item <?php if($current == 'categories') {echo ' active';} ?>">
      ...
      <!-- Nav Item - feedbacks -->
      <li class="nav-item <?php if($current == 'feedbacks') {echo ' active';} ?>">
        <a class="nav-link" href="feedbacks.php">
          <i class="fas fa-fw fa-comment"></i>
          <span>Feedbacks</span>
          <span class="badge badge-info ml-1">
          <?php echo newFeedbackCount(); ?>
          </span>
        </a>
